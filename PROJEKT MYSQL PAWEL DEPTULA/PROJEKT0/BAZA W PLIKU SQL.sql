CREATE DATABASE  IF NOT EXISTS `tajnaorganizacja` /*!40100 DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_0900_ai_ci */ /*!80016 DEFAULT ENCRYPTION='N' */;
USE `tajnaorganizacja`;
...
--
-- Temporary view structure for view `laczenie 3 tabel pokaz pracownikow bankierow`
--

DROP TABLE IF EXISTS `laczenie 3 tabel pokaz pracownikow bankierow`;
/*!50001 DROP VIEW IF EXISTS `laczenie 3 tabel pokaz pracownikow bankierow`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `laczenie 3 tabel pokaz pracownikow bankierow` AS SELECT 
 1 AS `IMIE`,
 1 AS `ROLA`,
 1 AS `id_pana`,
 1 AS `IMIESZEFAPOSREDNIEGO`,
 1 AS `id_szefa`,
 1 AS `IMIEPRACOWNIKA`,
 1 AS `SPECJALIZACJA`,
 1 AS `id_pracownika`*/;
...
--
-- Temporary view structure for view `panowie sluzacy imperatorowi`
--

DROP TABLE IF EXISTS `panowie sluzacy imperatorowi`;
/*!50001 DROP VIEW IF EXISTS `panowie sluzacy imperatorowi`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `panowie sluzacy imperatorowi` AS SELECT 
 1 AS `id_pana`,
 1 AS `IMIE`,
 1 AS `NAZWISKO`,
 1 AS `LOJALNOSC`,
...
--
-- Temporary view structure for view `podzapytanie wyswietl slugi niezachwianych panow`
--

DROP TABLE IF EXISTS `podzapytanie wyswietl slugi niezachwianych panow`;
/*!50001 DROP VIEW IF EXISTS `podzapytanie wyswietl slugi niezachwianych panow`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `podzapytanie wyswietl slugi niezachwianych panow` AS SELECT 
 1 AS `id_szefa`,
 1 AS `IMIE`,
 1 AS `NAZWISKO`,
 1 AS `data_zakontraktowania`,
...
--
-- Temporary view structure for view `podzapytanie z 5 tabel`
--

DROP TABLE IF EXISTS `podzapytanie z 5 tabel`;
/*!50001 DROP VIEW IF EXISTS `podzapytanie z 5 tabel`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `podzapytanie z 5 tabel` AS SELECT 
 1 AS `id_pracownika`,
 1 AS `IMIE`,
 1 AS `NAZWISKO`,
 1 AS `SPECJALIZACJA`,
...
--
-- Temporary view structure for view `wyswietl pracownikow starszych kiblowych`
--

DROP TABLE IF EXISTS `wyswietl pracownikow starszych kiblowych`;
/*!50001 DROP VIEW IF EXISTS `wyswietl pracownikow starszych kiblowych`*/;
SET @saved_cs_client     = @@character_set_client;
/*!50503 SET character_set_client = utf8mb4 */;
/*!50001 CREATE VIEW `wyswietl pracownikow starszych kiblowych` AS SELECT 
 1 AS `id_pracownika`,
 1 AS `IMIE`,
 1 AS `NAZWISKO`,
 1 AS `SPECJALIZACJA`,
...
--
-- Final view structure for view `laczenie 3 tabel pokaz pracownikow bankierow`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `laczenie 3 tabel pokaz pracownikow bankierow` AS select `panowie`.`IMIE` AS `IMIE`,`panowie`.`ROLA` AS `ROLA`,`panowie`.`id_pana` AS `id_pana`,`sludzy`.`IMIE` AS `IMIESZEFAPOSREDNIEGO`,`sludzy`.`id_szefa` AS `id_szefa`,`pracownicy`.`IMIE` AS `IMIEPRACOWNIKA`,`pracownicy`.`SPECJALIZACJA` AS `SPECJALIZACJA`,`pracownicy`.`id_pracownika` AS `id_pracownika` from ((`panowie` left join `sludzy` on((`panowie`.`id_pana` = `sludzy`.`id_pana`))) join `pracownicy` on((`pracownicy`.`id_szefa` = `sludzy`.`id_szefa`))) where (`panowie`.`ROLA` = 'BANKIER') group by `panowie`.`IMIE` */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `panowie sluzacy imperatorowi`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `panowie sluzacy imperatorowi` AS select `panowie`.`id_pana` AS `id_pana`,`panowie`.`IMIE` AS `IMIE`,`panowie`.`NAZWISKO` AS `NAZWISKO`,`panowie`.`LOJALNOSC` AS `LOJALNOSC`,`panowie`.`ROLA` AS `ROLA`,`panowie`.`ID_KOSMITY` AS `ID_KOSMITY` from `panowie` where `panowie`.`ID_KOSMITY` in (select `kosmici`.`ID_KOSMITY` from `kosmici` where `kosmici`.`id_wladcy` in (select `wladcy`.`id_wladcy` from `wladcy` where (`wladcy`.`HIERARHIA` = 'IMPERATOR'))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `podzapytanie wyswietl slugi niezachwianych panow`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `podzapytanie wyswietl slugi niezachwianych panow` AS select `sludzy`.`id_szefa` AS `id_szefa`,`sludzy`.`IMIE` AS `IMIE`,`sludzy`.`NAZWISKO` AS `NAZWISKO`,`sludzy`.`data_zakontraktowania` AS `data_zakontraktowania`,`sludzy`.`WYDZIAL` AS `WYDZIAL`,`sludzy`.`id_pana` AS `id_pana` from `sludzy` where `sludzy`.`id_pana` in (select `panowie`.`id_pana` from `panowie` where (`panowie`.`LOJALNOSC` = 'NIEZACHWIANA')) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;

--
-- Final view structure for view `podzapytanie z 5 tabel`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `podzapytanie z 5 tabel` AS select `pracownicy`.`id_pracownika` AS `id_pracownika`,`pracownicy`.`IMIE` AS `IMIE`,`pracownicy`.`NAZWISKO` AS `NAZWISKO`,`pracownicy`.`SPECJALIZACJA` AS `SPECJALIZACJA`,`pracownicy`.`ZACHOWANIE` AS `ZACHOWANIE`,`pracownicy`.`id_szefa` AS `id_szefa`,`pracownicy`.`zarobkiSOCJALISTYCZNEXD` AS `zarobkiSOCJALISTYCZNEXD` from `pracownicy` where `pracownicy`.`id_szefa` in (select `sludzy`.`id_szefa` from `sludzy` where `sludzy`.`id_pana` in (select `panowie`.`id_pana` from `panowie` where `panowie`.`ID_KOSMITY` in (select `kosmici`.`ID_KOSMITY` from `kosmici` where `kosmici`.`id_wladcy` in (select `wladcy`.`id_wladcy` from `wladcy` where (`wladcy`.`HIERARHIA` = 'PIES SOMSIADA'))))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
--
-- Final view structure for view `wyswietl pracownikow starszych kiblowych`
--
...
/*!50001 CREATE ALGORITHM=UNDEFINED */
/*!50013 DEFINER=`root`@`localhost` SQL SECURITY DEFINER */
/*!50001 VIEW `wyswietl pracownikow starszych kiblowych` AS select `pracownicy`.`id_pracownika` AS `id_pracownika`,`pracownicy`.`IMIE` AS `IMIE`,`pracownicy`.`NAZWISKO` AS `NAZWISKO`,`pracownicy`.`SPECJALIZACJA` AS `SPECJALIZACJA`,`pracownicy`.`ZACHOWANIE` AS `ZACHOWANIE`,`pracownicy`.`id_szefa` AS `id_szefa`,`pracownicy`.`zarobkiSOCJALISTYCZNEXD` AS `zarobkiSOCJALISTYCZNEXD` from `pracownicy` where `pracownicy`.`id_szefa` in (select `sludzy`.`id_szefa` from `sludzy` where `sludzy`.`id_pana` in (select `panowie`.`id_pana` from `panowie` where (`panowie`.`ROLA` = 'STARSZY KIBLOWY'))) */;
/*!50001 SET character_set_client      = @saved_cs_client */;
/*!50001 SET character_set_results     = @saved_cs_results */;
/*!50001 SET collation_connection      = @saved_col_connection */;
...
-- Dump completed on 2021-01-06 23:31:06
